...
from .ir_camera import ir_emitted_on, ir_emitted_off
...
class VideoCapture:
    def __init__(self, config):
        ...
        if not os.path.exists(self.config.get("video", "device_path")):
            ...
            sys.exit(14)
        elif self.config.get("video", "is_ir_camera"):
            ir_emitted_on(self.config.get("video", "device_path"))
    ...
    def release(self):
        ...
        if self.config.get("video", "is_ir_camera"):
            ir_emitted_off(self.config.get("video", "device_path"))
